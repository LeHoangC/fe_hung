...
const CardUser = ({ onItemClick, activeColor, name }) => {
        ...
        <div className="bg-white shadow-lg rounded-lg p-4 max-w-sm mx-auto mt-10 mb-10">
            <div className="flex flex-col items-center mb-4">
                ...
                <div className="flex flex-col items-center">
                    <label className="text-lg font-semibold text-center">{name}</label>
                    <div className="text-white bg-red-500 w-[120px] text-center items-center p-1 rounded mt-1">
                        Thành viên
                    </div>
                </div>
            </div>
