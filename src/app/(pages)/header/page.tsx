...
const Header = () => {
    ...
    const getItemClass = (item: string) =>
        `font-bold cursor-pointer ${selected === item ? 'text-blue-500' : 'text-black'}`
        ...
        <div className="w-full">
            ...
            <div className="bg-customRed p-2.5  mx-auto text-x text-white">
                <div className="flex justify-around w-full items-center">
                    <div className="flex space-x-4">
                        <div>
                            Liên Hệ: <span className="font-bold text-sm">01234657988</span>
                        </div>
                        <div>
                            Email: <span className="font-bold text-sm">trandaihung@gmail.com</span>
                        </div>
                    </div>
                    ...
                    <div className="flex space-x-4">
                        ...
                        {fullName ? (
                            <div className="flex justify-center mt-[2px]">
                                ...
                                <div
                                    className="ml-4px font-bold text-[14px] text-center ml-[15px] cursor-pointer"
            ...
            <div className="flex justify-around items-center p-4 shadow-lg">
                ...
                <div className="flex space-x-8 items-center">
                    ...
                    <div
                        className={getItemClass('ĐG quyền sử dụng đất')}
                        onClick={() => handleClick('ĐG quyền sử dụng đất')}
                    >
                    ...
                    <div
                        className={getItemClass('Nạp tiền vào tài khoản')}
                        onClick={() => handleClick('Nạp tiền vào tài khoản')}
                    >
