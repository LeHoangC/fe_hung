                ...
                <div className="mt-6">
                    <div className="flex items-start mb-4">
                        ...
                        <label className="text-sm">
                            Tôi cam kết và chịu trách nhiệm trước pháp luật về thông tin đã cung cấp
                        </label>
                    </div>
                    ...
                    <div className="flex items-start mb-4">
                        ...
                        />
                        <label className="text-sm">
                            Tôi cam kết tuân thủ Quy định tham gia đấu giá trực tuyến tại website đấu giá trực tuyến
                        </label>
                    </div>
                </div>
